      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <section className="bg-[#0f0f0f] rounded-2xl border border-white/10 p-6">
          <div className="flex items-center gap-3 mb-4 border-b border-white/10 pb-4">
            ...
            <h2 className="text-xl font-semibold text-white">BEATS Scorecard</h2>
          </div>
          <div className="space-y-4 text-sm text-white/70">
            <p>
              <strong className="text-white">Bond Equity Allocation Timing Scorecard (BEATS)</strong> is a composite macro model designed to dynamically tilt portfolios between Equities and Fixed Income.
            </p>
